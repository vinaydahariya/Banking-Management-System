...
public class Signup extends JFrame implements ActionListener{
    ...
    Signup(){
        ...
        t8 = new JTextField();  // Text field for date of birth
        ...
        t8.setBounds(300, 240, 400, 30);  // Positioning date of birth text field
        add(t8);
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        String dob = t8.getText(); // Using text field for date of birth
        String gender = null;
        if (r1.isSelected()) {
            gender = "Male";
